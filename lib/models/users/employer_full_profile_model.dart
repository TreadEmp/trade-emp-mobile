...
class EmployerFullProfileResponseModel {
  bool? success;
  Data? data;

  EmployerFullProfileResponseModel({this.success, this.data});

  EmployerFullProfileResponseModel.fromJson(Map<String, dynamic> json) {

...
class ExperienceListResponseModel {
  ...
  ExperienceListResponseModel({this.success, this.data});

  ExperienceListResponseModel.fromJson(Map<String, dynamic> json) {
...
class ExperienceListRequestModel {
  String? page;
  String? pageSize;
  String? name;
  String? category;

  ExperienceListRequestModel({this.page, this.pageSize, this.name, this.category});

...
const COLOR_BLUE = Color.fromRGBO(22, 131, 227, 1.0);
const COLOR_BLUE_SHADE = Color.fromRGBO(22, 131, 227, 0.48);
const COLOR_POWDER_BLUE = Color.fromRGBO(176, 223, 229, 0.89);
const COLOR_WHITE = Colors.white;
const COLOR_DARK_BLUE = Color.fromRGBO(20, 25, 45, 1.0);
const COLOR_RED = Color.fromRGBO(255, 0, 0, 1.0);
const COLOR_GREEN = Color.fromRGBO(0, 108, 72, 1);
const COLOR_GREEN_BLACK = Color.fromRGBO(6, 23, 19, 1);
...
const TextTheme TEXT_THEME_DEFAULT = TextTheme(
    ...
    titleMedium: TextStyle(
        color: COLOR_BLACK, fontSize: 14, fontWeight: FontWeight.w400),
    titleSmall:
        TextStyle(color: COLOR_GREY, fontSize: 12, fontWeight: FontWeight.w400),
    labelLarge: TextStyle(
        color: COLOR_WHITE, fontSize: 14, fontWeight: FontWeight.w400));

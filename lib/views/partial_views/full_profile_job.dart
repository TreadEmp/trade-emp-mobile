...
class FullProfileJob extends StatelessWidget {
  final Jobs jobs;
  const FullProfileJob({Key? key, required this.jobs}) : super(key: key);
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                      ...
                      height: 152,
                      child:
                          Image.network(jobs.images![0].url!, fit: BoxFit.cover)),
                ),
              ],
            ),
            Column(

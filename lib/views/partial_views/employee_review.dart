...
class EmployeeReview extends StatelessWidget {
  final String? type;
  final latest_job_requests.Reviews? review;
  const EmployeeReview({Key? key, required this.review, this.type})
      : super(key: key);
  ...
  Widget getReviewImageContainer(List<latest_job_requests.Images> images) {
